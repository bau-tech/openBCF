...
/// <summary>
/// bcf.chladny.de's flat ifc_guid-list fields (selection, visibility_exceptions, coloring[].components)
...
internal sealed class ViewpointDto
{
    ...
    // bcf.chladny.de doesn't store viewpoints in the nested shape above at all - its
...
internal sealed class ViewpointWriteDto
{
    ...
    // bcf.chladny.de's ViewpointCreate (per /openapi.json) stores these as flat top-level fields,
