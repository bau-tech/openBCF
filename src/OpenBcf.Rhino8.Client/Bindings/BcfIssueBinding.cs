...
/// Connect (see <see cref="BcfSession"/>) - mirrors OpenBcf.Tekla2026.Client.Bindings.BcfIssueBinding.
/// Every method assumes a successful Connect already happened - there is no implicit reconnect.
/// </summary>
