...
/// <summary>
/// Offline .bcfzip exchange - mirrors OpenBcf.Tekla2026.Client.Bindings.BcfArchiveBinding exactly,
/// since this project also has UseWindowsForms enabled (for RhinoWindows.Controls.WpfElementHost).
/// </summary>
