...
/// <see cref="BcfServerConnection.DefaultServerUrl"/> (https://bcf.chladny.de) when none is supplied.
/// </summary>
public sealed class BcfServerClient : IBcfServerClient, IDisposable
{
    ...
    {
        var response = await SendAsync<ServerVersionsResponseDto>(HttpMethod.Get, "bcf/versions", null, cancellationToken);
    ...
    {
        var dto = await SendAsync<AuthOptionsDto>(HttpMethod.Get, $"bcf/{versionId}/auth", null, cancellationToken);
    ...
    {
        var authOptions = await GetAuthOptionsAsync(versionId, cancellationToken);
    ...
    {
        var dtos = await SendAsync<List<ProjectDto>>(HttpMethod.Get, $"bcf/{versionId}/projects", null, cancellationToken);
    ...
    {
        var dto = await SendAsync<ProjectDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}", null, cancellationToken);
    ...
    {
        var dto = await SendAsync<ExtensionDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/extensions", null, cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dtos = await SendAsync<List<TopicDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dto = await SendAsync<TopicDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}", null, cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<TopicDto>(HttpMethod.Post, $"bcf/{versionId}/projects/{Segment(projectId)}/topics", BcfRestMapper.ToWriteDto(topic), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<TopicDto>(HttpMethod.Put, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topic.Guid}", BcfRestMapper.ToWriteDto(topic), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<BimSnippetDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/snippet", null, cancellationToken);
    ...
    {
        var dtos = await SendAsync<List<ProjectFileInformationDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/files_information", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<FileDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/files", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<CommentDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dto = await SendAsync<CommentDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments/{commentGuid}", null, cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<CommentDto>(HttpMethod.Post, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments", BcfRestMapper.ToWriteDto(comment), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<CommentDto>(HttpMethod.Put, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments/{comment.Guid}", BcfRestMapper.ToWriteDto(comment), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dtos = await SendAsync<List<ViewpointDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dto = await SendAsync<ViewpointDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints/{viewpointGuid}", null, cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<ViewpointDto>(HttpMethod.Post, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints", BcfRestMapper.ToWriteDto(viewpoint, snapshotPngBytes), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    public async Task<byte[]> GetBitmapAsync(string versionId, string projectId, Guid topicGuid, Guid viewpointGuid, string bitmapReference, CancellationToken cancellationToken = default) =>
        await GetBytesAsync($"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints/{viewpointGuid}/bitmaps/{Segment(bitmapReference)}", cancellationToken);

    public async Task<IReadOnlyList<BcfComponent>> GetSelectedComponentsAsync(string versionId, string projectId, Guid topicGuid, Guid viewpointGuid, CancellationToken cancellationToken = default)
    {
        var dtos = await SendAsync<List<ComponentDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints/{viewpointGuid}/selection", null, cancellationToken);
        return dtos.Select(d => new BcfComponent(d.IfcGuid, d.OriginatingSystem, d.AuthoringToolId)).ToList();
    }

    public async Task<IReadOnlyList<BcfColoring>> GetColoredComponentsAsync(string versionId, string projectId, Guid topicGuid, Guid viewpointGuid, CancellationToken cancellationToken = default)
    {
        var dto = await SendAsync<ComponentsDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints/{viewpointGuid}/coloring", null, cancellationToken);
        return dto.Coloring?.Select(c => new BcfColoring(c.Color) { Components = c.Components?.Select(d => new BcfComponent(d.IfcGuid, d.OriginatingSystem, d.AuthoringToolId)).ToList() ?? new List<BcfComponent>() }).ToList()
            ?? new List<BcfColoring>();
    }

    public async Task<BcfComponentVisibility?> GetVisibilityAsync(string versionId, string projectId, Guid topicGuid, Guid viewpointGuid, CancellationToken cancellationToken = default)
    {
        var dto = await SendAsync<VisibilityDto>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/viewpoints/{viewpointGuid}/visibility", null, cancellationToken);
        return new BcfComponentVisibility(dto.DefaultVisibility)
        {
            Exceptions = dto.Exceptions?.Select(d => new BcfComponent(d.IfcGuid, d.OriginatingSystem, d.AuthoringToolId)).ToList() ?? new List<BcfComponent>(),
        };
    }
    ...
    {
        var dtos = await SendAsync<List<RelatedTopicDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/related_topics", null, cancellationToken);
    ...
    public async Task<IReadOnlyList<Guid>> PutRelatedTopicsAsync(string versionId, string projectId, Guid topicGuid, IReadOnlyList<Guid> relatedTopicGuids, CancellationToken cancellationToken = default)
    {
        ...
        var dtos = await SendAsync<List<RelatedTopicDto>>(HttpMethod.Put, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/related_topics", body, cancellationToken);
        return dtos.Select(d => Guid.Parse(d.RelatedTopicGuid)).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<DocumentReferenceDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/document_references", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dto = await SendAsync<DocumentReferenceDto>(HttpMethod.Post, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/document_references", BcfRestMapper.ToDto(reference), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dto = await SendAsync<DocumentReferenceDto>(HttpMethod.Put, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/document_references/{reference.Guid}", BcfRestMapper.ToDto(reference), cancellationToken);
        return BcfRestMapper.ToDomain(dto);
    }
    ...
    {
        var dtos = await SendAsync<List<DocumentDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/documents", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    public async Task<BcfServerDocument> CreateDocumentAsync(string versionId, string projectId, string fileName, byte[] content, CancellationToken cancellationToken = default)
    {
        ...
        using var response = await _httpClient.SendAsync(request, cancellationToken);
        await EnsureSuccessAsync(response, cancellationToken);
        var dto = await response.Content.ReadFromJsonAsync<DocumentDto>(cancellationToken: cancellationToken)
    ...
    public async Task<byte[]> GetDocumentAsync(string versionId, string projectId, Guid documentGuid, CancellationToken cancellationToken = default) =>
        await GetBytesAsync($"bcf/{versionId}/projects/{Segment(projectId)}/documents/{documentGuid}", cancellationToken);
    ...
    {
        var dtos = await SendAsync<List<EventDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/events", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<EventDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/events", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<EventDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments/events", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    {
        var dtos = await SendAsync<List<EventDto>>(HttpMethod.Get, $"bcf/{versionId}/projects/{Segment(projectId)}/topics/{topicGuid}/comments/{commentGuid}/events", null, cancellationToken);
        return dtos.Select(BcfRestMapper.ToDomain).ToList();
    }
    ...
    private async Task SendNoContentAsync(HttpMethod method, string relativeUrl, CancellationToken cancellationToken) =>
        await SendNoContentAsync(method, relativeUrl, null, cancellationToken);
    ...
    private static async Task EnsureSuccessAsync(HttpResponseMessage response, CancellationToken cancellationToken)
    {
        ...
        // BCFree.Core targets net48 alongside net8.0.
